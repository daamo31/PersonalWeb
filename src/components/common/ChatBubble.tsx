    ...
    >
      <ExpandableChatHeader>
        <div className="flex items-center space-x-3">
          <Avatar className="h-8 w-8 border-2 border-primary bg-blue-300 dark:bg-blue-600">
            ...
            {messages.map((message) => (
              ...
              >
                <div className="flex items-start space-x-2">
                  {message.sender === 'bot' && (
                    <Avatar className="h-6 w-6 border-2 border-primary bg-blue-300 dark:bg-blue-600">
                      <AvatarImage src={heroConfig.avatar} alt={heroConfig.name} />
                      <AvatarFallback>AI</AvatarFallback>
                    </Avatar>
                  )}
